...
<head>
    ...
    <meta name="Author" content="Joy Towns" />
    <!-- Bootstrap CSS -->
    ...
    <meta name="description"
        content="Joy Towns Niagara, a development by Branthaven, is an upcoming townhouse community in Niagara Falls, located on Oakwood Drive. The project is expected to be completed in 2025.">
    <meta name="keywords"
        content="Joy Towns, Joy Towns town, Joy Towns Niagara, Towns in Niagara, Joy Towns Branthaven, Branthaven">
    <meta name="robots" content="index, follow">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <meta name="language" content="English">
    <meta name="revisit-after" content="1 days">
    <meta property="og:image" content="https://joytowns.ca/joy-towns-1.jpg">
    <meta property="og:site_name" content="Joy Towns" />
...
<body>
        ...
        <nav class="navbar navbar-expand-md navbar-light" id="navbar">
            <div class="container">
                <a href="/" class="navbar-brand">
                    <img src="./images/joy-logo.png" class="navbar-brand" alt="joy towns logo">
                </a>
            ...
            <div class="container" id="hero">
                <div class="row me-0 row-cols-1 row-cols-md-2 d-flex align-items-center">
                      ...
                      Condos
                                ...
                                <div class="pt-2 pt-sm-2 pt-md-2 rounded-mine mt-3 ">
                                    ...
                                    <h2 class="headline-textt headline-textt-sm pb-3 fw-bold fs-5 center-sm">Pricing
                                        starting from low <span style="color:red;"> $500!</span> </h2>
                                    <h2 class="headline-textt headline-textt-sm">

                                        <span class="fw-bold">Joy Towns</span>, a development by Branthaven, is an
                                        upcoming townhouse community in Niagara Falls, located on Oakwood Drive. These 2
                                        and 3-story townhomes are thoughtfully designed to cater to the needs of growing
                                        families, multi-generational households, real estate investors, and those
                                        interested in shared homeownership. The project is expected to be completed in
                                        2025.
                                        <div class="list d-block headline-textt pt-4">
                                            ...
                                            <p class="mybot pb-md-0 pb-0 ">
                                                Address: Oakwood Dr & McLeod Rd, Niagara, Ontario
                                            </p>
                                            <p class="mybot pb-md-0 pb-0 ">
                                                Occupancy: 2025
                                            </p>
                    ...
                    <div class="col position-relative order-1 order-md-2">
                        <img src="./images/joy-towns-1.jpg" class="img-fluid" id="myVideo" alt="Joy Towns">
                    </div>
                </div>
        ...
        <section id="gallery">
            <div class="container">
                ...
                <div class="pt-md-5 pt-5">
                    <h2
                        class="fw-bold fs-1 pb-2  ps-3 ps-md-0 d-flex justify-content-center custom-underline brand-color">
                        Model and Renderings
                    </h2>

                    <span class="small-text text-center d-flex justify-content-center custom-underline pb-3"> See the
                        beautiful inside and out of Joy Towns Niagara</span>
                    <div>
                        <section>
                            <div class="rounded-3">
                                <div class="d-flex justify-content-between pb-3">
                                    <div
                                        ...
                                        <div class="col">
                                            <div class="afte">
                                                <img loading="lazy" src="images/joy-towns-2.jpg" alt="Joy Towns"
                                                    class="img-fluid imghei">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="afte">
                                                <img loading="lazy" src="images/joy-towns-3.jpg" alt="Joy Towns"
                                                    class="img-fluid imghei">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div href="#" class="afte">
                                                <img loading="lazy" src="images/joy-towns-4.jpg" alt="Joy Towns"
                                                    class="img-fluid imghei">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="afte">
                                                <img loading="lazy" src="images/joy-towns-5.jpg" alt="Joy Towns"
                                                    class="img-fluid imghei">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="afte">
                                                <img loading="lazy" src="images/joy-towns-6.jpg" alt="Joy Towns"
                                                    class="img-fluid imghei">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div href="#" class="afte">
                                                <img loading="lazy" src="images/joy-towns-7.jpg" alt="Joy Towns"
                                                    class="img-fluid imghei">
                                            </div>
                                        </div>
        ...
        <div class="container pt-3 " data-aos="fade-up" data-aos-duration="2000" data-aos-delay="200">
            ...
            <div class="pt-md-5 pt-5" data-aos="fade-up">
                ...
                <p class="textt justify-content-center brand-color center-sm">
                    Joy Towns in Niagara Falls is a Brand New Pre-construction development by Branthaven, Located at
                    Oakwood Drive in Niagara Falls.
                </p>
            </div>
            <div class="d-flex justify-content-center text-center textt">
                <div class="list d-block ">
                    ...
                    <p class="mybot pb-md-0 pb-0 ">
                        <span class="fw-bold">3-Storey Rear Lane Townhome with Secondary Suite -</span> 1950 sq.ft. -
                        2100sq.ft
                    </p>
        ...
        <div class="container pt-md-5 pt-sm-2">
            ...
            <div class="py-5" id="location">
                <h2 class="fw-bold fs-1 mb-0 text-center justify-content-center brand-color">
                    <span class="mx-1">Joy Towns - Location </span>
                </h2>
                <span class="small-text text-center d-flex justify-content-center custom-underline pb-3">Oakwood Dr &
                    McLeod Rd, Niagara, Ontario</span>
                <div>
                    <div class="bg-white p-1   rounded-mine d-flex justify-content-center">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2914.627222852222!2d-79.1173781!3d43.07030719999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89d344709cdd507d%3A0x169de8792c91286!2sOakwood%20Dr%20%26%20McLeod%20Rd%2C%20Niagara%20Falls%2C%20ON%2C%20Canada!5e0!3m2!1sen!2snp!4v1696403781859!5m2!1sen!2snp"
    ...
    <section>
        <div class="container pt-md-5 pt-5" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="50">
                    ...
                    <div style="border:0;outline:0;padding:0; margin: 11px 9px 0;">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <a rel="nofollow"
                                    href="https://www.walkscore.com/score/Oakwood-Dr-&-McLeod-Rd-Niagara-?utm_source=badge&utm_medium=responsive&utm_campaign=badge"><!--[if lte IE 8]><img src="//pp.walk.sc/badge/walk/Oakwood-Dr-&-McLeod-Rd-Niagara-.png" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Walk Score of this location"><![endif]-->
                                    <!--[if gt IE 8]><img src="//pp.walk.sc/badge/walk/Oakwood-Dr-&-McLeod-Rd-Niagara-.svg" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Walk Score of this location"><![endif]-->
                                    <!--[if !IE]> <!-- --><img
                                        src="//pp.walk.sc/badge/walk/Oakwood-Dr-&-McLeod-Rd-Niagara-.svg"
                                        ...
                                        alt="Walk Score of this location"><!-- <![endif]--><!--[if lte IE 8]><img src="//pp.walk.sc/badge/transit/Oakwood-Dr-&-McLeod-Rd-Niagara-.png" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Transit Score of this location"><![endif]-->
                                    <!--[if gt IE 8]><img src="//pp.walk.sc/badge/transit/Oakwood-Dr-&-McLeod-Rd-Niagara-.svg" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Transit Score of this location"><![endif]-->
                                    <!--[if !IE]> <!-- --><img
                                        src="//pp.walk.sc/badge/transit/Oakwood-Dr-&-McLeod-Rd-Niagara-.svg"
                                        style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'
                                        alt="Transit Score of this location"><!-- <![endif]--><!--[if lte IE 8]><img src="//pp.walk.sc/badge/bike/Oakwood-Dr-&-McLeod-Rd-Niagara-.png" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Bike Score of this location"><![endif]-->
                                    <!--[if gt IE 8]><img src="//pp.walk.sc/badge/bike/Oakwood-Dr-&-McLeod-Rd-Niagara-.svg" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Bike Score of this location"><![endif]-->
                                    <!--[if !IE]> <!-- --><img
                                        src="//pp.walk.sc/badge/bike/Oakwood-Dr-&-McLeod-Rd-Niagara-.svg"
                                        style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'
                                        alt="Bike Score of this location"><!-- <![endif]--></a>
                            </div>
                        </div>
                        <p
                            ...
                            <a rel="nofollow"
                                ...
                                target="_blank"
                                href="https://www.walkscore.com/CA-ON/Niagara_Falls/Lundy?utm_source=badge&utm_medium=responsive&utm_campaign=badge">Explore
                                Lundy on Walk Score</a><img style="visibility: hidden;" width=1 height=1
            ...
            <div class="pt-4 ">
                <span class="small-text text-center d-flex justify-content-center custom-underline pb-3 textt">(Joy
                    Towns Niagara)
                    Oakwood Dr & McLeod Rd, Niagara has a Walk Score of 71 out of 100. This location is Very Walkable so
                    most errands can be accomplished on foot.

                    This location is in the Lundy neighborhood in Niagara Falls
        ...
        <div class="container pt-md-5 pt-5" id="location">
            ...
            <div class="py-5">
                ...
                <span class="small-text text-center d-flex justify-content-center custom-underline pb-3 px-2">Walk
                    around the neighbourhood near Joy Towns</span>

                <div class="p-1  d-flex justify-content-center">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!4v1696404429697!6m8!1m7!1s9BLuESsP5Ba8K_55o1y3vw!2m2!1d43.07033961908436!2d-79.11749719653801!3f8.286616846854566!4f0.7347149422197248!5f0.4000000000000002"
                        width="90%" height="550" style="border:0;" allowfullscreen="" loading="lazy"
                        referrerpolicy="no-referrer-when-downgrade"></iframe>
            ...
            <div class="pt-5 mt-5">
                <div class="row mx-0 ">
                    ...
                    <div class="registertext px-4 d-flex justify-content-center align-items-center  text-center">
                        <p>Register today to get the more information on Joy Towns coming up in Niagara
                        </p>
                    </div>
                        ...
                        <form action="./contactForm.php" method="POST">
                            ...
                            <div class="row">
                                <p class="text-muted sm-text text-center mt-0">*I consent to receive future
                                    communications about Joy Towns. I understand I can opt out at anytime by sending an
                                    email.</p>
                            </div>
                            <div class="row">
        ...
        <div class="container ">
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-5 pt-5 justify-content-between ">
                <div class="col-md-5 my-3  center-sm px-4 px-md-0">
                    <p class=" ">
                    <h1 class="navbar-brand-foot fs-4 "><a href="https://homebaba.ca/niagara/joy-towns" target="_blank"
                            class="text-dark text-decoration-none">Joy Towns</a></h1>
                    </p>
                    <span class="sm-text justifyy text-secondary">
                        ...
                        those under contract with another brokerage. All inquiries will go to Sam Valji, Sales
                        Representative from Bay Street Group Inc. Email: samvalji.homebaba@gmail.com</span>
                ...
                <div class="col-md-4 py-md-5 py-5 center-sm px-md-5 px-5 ">
                    <div>
                        <h5 class="text-dark fw-bold mt-3 mb-3 ">About Joy Towns</h5>
                        <div class="list d-block ">
                            <p class="mybot pb-md-0 pb-0 ">
                                Builder : Branthaven
                            </p>
                ...
                <div class="col-md-2 mt-md-5 pt-md-5 mt-sm-0 pt-4 center-sm d-flex  justify-content-center">
                    <img src="images/branthaven-logo.svg" class="img-fluid regoimg mx-3" alt="branthaven-logo">
